/* 00101101111|chars|mk|0011100010100 */
...
function (t, e, n) {
  ...
  d = function (t) {
    function e(t, n) {
      ...
      return r.fontSize = !n.flat && n.fontSize > 10 * n.width ? 10 * n.width : n.fontSize,
    ...
    d = function (t) {
      function e(t, n) {
        ...
        var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
        return r.displayValue = n.displayValue,
      ...
      f(e, [
        ...
        },
        {
          ...
          value: function () {
            var t = '';
            return t += '101',
            t += (0, s.default) (this.data.substr(0, 6), 'LLLLLL'), t += '01010', t += (0, s.default) (this.data.substr(6, 6), 'RRRRRR'), t += '101', {
              data: t,
              text: this.text
            }
          }
        },
        {
          ...
          value: function () {
            ...
            t.push({
              data: '101' + (0, s.default) (this.data[0], 'L'), options: {
                height: this.guardHeight
              }
            }), t.push({
              data: (0, s.default) (this.data.substr(1, 5), 'LLLLL'), text: this.text.substr(1, 5), options: {
                fontSize: this.fontSize
              }
            }), t.push({
              data: '01010',
              ...
              data: (0, s.default) (this.data.substr(6, 5), 'RRRRR'), text: this.text.substr(6, 5), options: {
                fontSize: this.fontSize
              }
            }), t.push({
              data: (0, s.default) (this.data[11], 'R') + '101', options: {
                height: this.guardHeight
              }
      ...
      function i(t, e, n) {
        for (var i = 0; i < t.length; i++) {
          var u,
          a = t[i],
          c = (0, s.default) (e, a.options); u = c.displayValue ? f(a.text, c, n)  : 0; var l = a.data.length * c.width; a.width = Math.ceil(Math.max(u, l)), a.height = r(a, c), a.barcodePadding = o(u, l, c)
        }
      }
      function u(t) {
      ...
      function f(t, e, n) {
        ...
        return r.font = e.fontOptions + ' ' + e.fontSize + 'px ' + e.font,
    ...
    function (t, e, n) {
      ...
      function o(t) {
        ...
        if (t && 'svg' === t.nodeName || 'undefined' != typeof SVGElement && t instanceof SVGElement) return {
          element: t,
          options: (0, c.default) (t), renderer: l.default.SVGRenderer
        }; if ('undefined' != typeof HTMLCanvasElement && t instanceof HTMLCanvasElement) return {
          element: t,
          options: (0, c.default) (t), renderer: l.default.CanvasRenderer
    ...
    function (t, e, n) {
      ...
      function o(t, e, n) {
        ...
        var o = r.encode();
        o = (0, p.default) (o); for (var i = 0; i < o.length; i++) o[i].options = (0, s.default) (n, o[i].options); return o
      }
      function i() {
        return f.default.CODE128 ? 'CODE128' : Object.keys(f.default) [0]
      }
      function u(t, e, n) {
        e = (0, p.default) (e); for (var r = 0; r < e.length; r++) e[r].options = (0, s.default) (n, e[r].options), (0, h.default) (e[r].options); (0, h.default) (n), new (0, t.renderer) (t.element, e, n).render(), t.afterRender && t.afterRender()
      }
      var a = n(15), f = r(a), c = n(5), s = r(c), l = n(19), p = r(l), d = n(17), h = r(d), y = n(18), b = r(y), _ = n(9), v = r(_), g = n(16), O = r(g), E = n(8), w = n(10), m = r(w), j = function () {
      }, x = function (t, e, n) {
        var r = new j;
        if (void 0 === t) throw Error('No element to render on was provided.');
        return r._renderProperties = (0, b.default) (t), r._encodings = [
        ], r._options = m.default,
        r._errorHandler = new O.default(r),
        void 0 !== e && (n = n || {
        }, n.format || (n.format = i()), r.options(n) [n.format](e, n).render()),
        r
      };
      ...
      for (var P in f.default) f.default.hasOwnProperty(P) && function (t, e) {
        j.prototype[e] = j.prototype[e.toUpperCase()] = j.prototype[e.toLowerCase()] = function (n, r) {
          ...
          return i._errorHandler.wrapBarcodeCall(function () {
            ...
            var u = (0, s.default) (i._options, r); u = (0, v.default) (u); var a = t[e], f = o(n, a, u); return i._encodings.push(f), i
          })
        }
      }(f.default,
      P); j.prototype.options = function (t) {
      ...
      j.prototype.init = function () {
        if (this._renderProperties) {
          Array.isArray(this._renderProperties) || (this._renderProperties = [
            this._renderProperties
          ]);
          var t;
          for (var e in this._renderProperties) {
            t = this._renderProperties[e];
            var n = (0, s.default) (this._options, t.options); 'auto' == n.format && (n.format = i()), this._errorHandler.wrapBarcodeCall(function () {
              var e = n.value,
    ...
    function (t, e, n) {
      ...
      l = function (t) {
        function e(t, n) {
          if (o(this, e), /^[\x00-\x7F\xC8-\xD3]+$/.test(t)) var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, (0, s.default) (t), n));  else var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n)); return i(r)
        }
        return u(e, t),
        e
      }(f.default); e.default = l
    }, function (t, e, n) {
      'use strict';
      function r(t, e) {
        ...
        a(e, [
          ...
          },
          {
            ...
            value: function () {
              ...
              return {
                data: '1011' + (0, s.default) (this.data, t, '01'), text: this.text
              }
            }
          }
          ]), e
        ...
        h = function (t) {
          ...
          b = function (t) {
            function e(t, n) {
              o(this, e);
              var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
              if (r.isValid = !1, - 1 !== t.search(/^[0-9]{6}$/)) r.middleDigits = t,
              r.upcA = a(t, '0'),
            ...
            c = function (t) {
              ...
              u(e, [
                ...
                },
                {
                  ...
                  value: function () {
                    for (var t = [
                    ], e = this.getEncodings(), n = 0; n < this.data.length; n++) t.push(e[this.data.charAt(n)]),
              ...
              return o(t, [
                {
                  ...
                  value: function () {
                    ...
                    for (var t = 0; t < this.encodings.length; t++) {
                      var e = (0, u.default) (this.options, this.encodings[t].options); this.drawCanvasBarcode(e, this.encodings[t]), this.drawCanvasText(e, this.encodings[t]), this.moveCanvasDrawing(this.encodings[t])
                    }
                    this.restoreCanvas()
                  }
                },
                {
                  ...
                  value: function () {
                    ...
                    t.save(),
                    (0, a.calculateEncodingAttributes) (this.encodings, this.options, t);
                ...
                return o(t, [
                  {
                    ...
                    value: function () {
                      ...
                      for (var e = 0; e < this.encodings.length; e++) {
                        ...
                        r = (0, u.default) (this.options, n.options), o = this.createGroup(t, r.marginTop, this.svg); this.setGroupOptions(o, r), this.drawSvgBarcode(o, r, n), this.drawSVGText(o, r, n), t += n.width
                      }
                    }
                  },
                  {
                    ...
                    value: function () {
                      ...
                      this.options.background && this.drawRect(0, 0, n, e, this.svg).setAttribute('style', 'fill:' + this.options.background + ';')
                    }
                  },
                  {
                    key: 'drawSvgBarcode',
                    value: function (t, e, n) {
                      ...
                      for (var i = 0, u = 0, a = 0; a < o.length; a++) u = a * e.width + n.barcodePadding,
                      '1' === o[a] ? i++ : i > 0 && (this.drawRect(u - e.width * i, r, e.width * i, e.height, t), i = 0);
                  ...
                  },
                  {
                    ...
                    value: function (t, e, n) {
                      ...
                      if (e.displayValue) {
                        ...
                        'left' == e.textAlign || n.barcodePadding > 0 ? (o = 0, r.setAttribute('text-anchor', 'start'))  : 'right' == e.textAlign ? (o = n.width - 1, r.setAttribute('text-anchor', 'end'))  : (o = n.width / 2, r.setAttribute('text-anchor', 'middle')),
                        r.setAttribute('x', o),
                        r.setAttribute('y', i),
                  ...
                  },
                  {
                    ...
                    value: function (t, e, n) {
                      ...
                      return r.setAttribute('transform', 'translate(' + t + ', ' + e + ')'),
                      n.appendChild(r),
                      r
                    }
                  },
